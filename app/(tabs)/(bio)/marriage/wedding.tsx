...
export default function TabTwoScreen() {
  return (
    <ParallaxScrollView
      ...
      headerImage={
        <Image
          source={require('@/assets/images/Maahwage.jpeg')}
...
<ThemedText></ThemedText>
    <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
      <Button
        title="Honeymoon"
        onPress={() => router.push("/marriage/honeymoon")}
      />
    </View>
    </ParallaxScrollView>
  );
...
export function M4APlayer() {
  ...
  async function play1() {
    const { sound } = await Audio.Sound.createAsync(
      require("@/assets/songs/all_my_life.m4a")     );
    setSound(sound);
  ...
  return (
    <View>
      <Button title="Song: All My Life by Linda Ronstadt & Aaron Neville" onPress={play1} />
    </View>
  );
}
